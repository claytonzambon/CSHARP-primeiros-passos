...
namespace _28._3_Exercicio_URI_1061
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Let a segunda linha, armazenando o valor de X (hora), Y (minuto), Z (segundo)
            ...
            //Agora vamos desmembrar a duração em segundos para dia (W), hora (X), minutos (Y) e segundos (Z) restantes
            W = duracao / (24 * 60 * 60);
